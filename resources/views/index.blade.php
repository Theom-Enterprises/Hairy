    ...
    <header class="background" id="home">
        <div class="container pt-3">
            <div class="row align-items-center justify-content-center page-header">
                <div class="col-md-5">
                    <h2>Build a website using HAIRY</h2>
                    <P>
        ...
        <div class="container">
            <div class="row text-center">
                <div>
                    ...
                    <button type="button" class="btn btn-lg">Registrieren Sie Sich</button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Cras porta imperdiet odio, at accumsan ligula fermentum non. In auctor vestibulum arcu.
                        Nullam mollis felis id sem tristique, nec facilisis diam blandit. Quisque id augue enim.
                        Aenean at arcu cursus, consectetur neque vitae, egestas purus.
                    </p>
                </div>
