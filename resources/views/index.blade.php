...
@section('content')
    <header class="page-header d-flex flex-column">
        <div class="container h-100 d-flex align-items-center justify-content-center flex-grow-1 flex-shrink-0">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-5">
                    ...
                    <p>
                        In einer sich ständig weiterentwickelnden Geschäftswelt ist es sehr wichtig, auf dem
                        Laufenden
                        zu bleiben.
                        Je mehr Zeit vergeht, desto mehr Verbesserungen werden den Kunden von den Konkurrenten
                        angeboten.
                        Ein Online-Buchungssystem für Friseure auf deren Website wird ihre Aufmerksamkeit erregen
                        und
                        sie dazu bringen,
                        Dienste erneut in Anspruch zu nehmen, da es so einfach ist, einen Termin zu buchen.
                    </p>

                    <button type="button" class="btn btn-hairy-primary btn-lg"><a href="#features">Read More</a>
                    </button>
        ...
        <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <p class="my-4">
                        Es gibt Möglichkeiten, Ihr Friseurgeschäft noch effizienter zu gestalten, und ein
                        Online-Buchungssystem für Friseure ist definitiv eine davon.
                        Mit einem Online-Buchungssystem können Sie Ihre Kunden bei der Registrierung für die von Ihnen
        ...
        <div class="container">
            <div class="row text-center">
                <div>
                    ...
                    <button type="button" class="btn btn-hairy-primary btn-lg"><a href="{{route('register')}}">Registrieren
                            Sie sich</a>
                    </button>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6">
                    ...
                    <p>Mit HAIRY dem Online-Buchungssystem erfolgen Buchungen für verschiedenste Termine beim Friseur
                        über die Website des Friseursalons.
                        Ihre Kunden können rund um die Uhr kostenlose Termine auswählen und diese über die Website
                        buchen.
                ...
                <div class="col-md-5">
                    ...
                    <p>Stärken Sie die Beziehung zu Ihren Kunden. Beschreiben Sie einfach Ihre Leistungen, zeigen Sie
                        an, wann diese verfügbar sind und Sie werden
