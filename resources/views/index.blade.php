...
@section('content')
    <header class="page-header d-flex flex-column">
        ...
        <svg class="flex-shrink-0 svg-margin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    ...
    <section class="feature background" id="features">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="svg-margin">
            <path fill="#f3f4f5" fill-opacity="1" d="M0,192L1440,128L1440,320L0,320Z"></path>
        </svg>
    </section>
    <section class="icons">
